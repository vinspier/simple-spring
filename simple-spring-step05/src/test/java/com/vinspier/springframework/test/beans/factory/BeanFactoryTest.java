...
public class BeanFactoryTest {
    ...
    public void testClasspathApplicationContext() {
        ...
        ApplicationContext applicationContext = new ClasspathApplicationContext(configLocation);
        Set<String> beanDefinitionNames = applicationContext.getBeanDefinitionNames();
        StockService stockService = (StockService) applicationContext.getBean("stockService");
        System.out.println("--------> get stock result for skuId 1110 is [" + stockService.getStock(1110L) + "]");
        System.out.println("--------> stockServiceImpl's warehouse is " + stockService.getWarehouse());
    }
